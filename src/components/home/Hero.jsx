                    ...
                    <div key={index} className="relative h-[400px]  lg:h-[600px]">
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center h-full">
                            <div className="text-center   p-6 md:p-10 rounded-lg max-w-2xl mx-4">
                                <h2 className="text-3xl h-font md:text-4xl font-bold text-black mb-4">{slide.title}</h2>
                                <p className="text-sm p-font md:text-lg text-gray-700">{slide.description}</p>
